...
public class EXT330 extends ExtendM3Batch {
  ...
  public void main() {
    ...
    Map<String, String> params = ["FILE":"SER001", "PK01":"SER001"]; // if does not exisit in meta data publisher add with CUSEXTMI/AddFieldValue
    ...
    //expression = expression.eq("ICPUOS", "35").and(expression.eq("ICTRDT", "20240906")); // for testing only
   ...
   */
   private deleteFromEXTIND() {
    ...
    DBContainer EXTIND = queryEXTIND.getContainer();
		...
		queryEXTIND.readAllLock(EXTIND, 1, deleteEXTIND);
   }
    /*
