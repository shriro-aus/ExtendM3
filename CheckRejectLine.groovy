 ...
 *SH001            20241001   ONKARK           Processes rejected workflow lines in EXTOLN
 *
 *
 */
...
public class CheckRejectLine extends ExtendM3Transaction {
    ...
    void countRejecedAndProcessLines() {
        DBAction query = database.table("EXTOLN").index("00").selectAllFields().build();
        ...
        int nrOfKeys = 1;
        query.readAll(container, nrOfKeys, callback); // Read all matching records
