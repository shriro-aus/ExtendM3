 ...
 *SH001             20241001  ONKARK           lists ordernumber with line stop 1 from EXTOLN
 *
 *
 */
...
public class ListNonCOStop extends ExtendM3Transaction {
    ...
    /*
     * Retrieves and processes records from the EXTOLN table.
       * Set company number in the container
