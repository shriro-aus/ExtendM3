 ...
 *SH001             20241001  ONKARK           Update stop status in OOLINE table 
 *
 *
 */
...
public class UpdCoStopAppr extends ExtendM3Transaction {
    ...
    private String inORNO, inPONR, inCONO, inPOSX, inSTOP;
    ...
    private void getApiInput() {
        ...
        logger.warning("POSX value is: ${mi.inData.get("POSX")}");
        ...
        logger.warning("inPOSX value is: ${inPOSX}");
